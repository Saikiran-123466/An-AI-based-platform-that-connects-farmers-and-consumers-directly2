...
router.get('/recommendations/consumer/:id', (req, res) => {
    ...
    const recommendations = [
        { name: 'Fresh Organic Spinach', reasoning: 'Because it is currently in peak season locally.', price: 5.0 },
        { name: 'Farm-Fresh Eggs', reasoning: 'Based on your previous frequent purchases.', price: 4.5 }
    ];
